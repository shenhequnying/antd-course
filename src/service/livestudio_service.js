...
export function queryList() {
  return request("http://172.16.109.91:5000/live_studio_style_infolist");
...
export function queryBaseInfoList() {
  return request("http://172.16.109.91:5000/base_studio_info_list");
...
export function update(id, data) {
  ...
  return request(
    `http://172.16.109.91:5000/live_studio_style_info_single/${id}`,
    {
...
export function search(data) {
  ...
  // console.log("")
  // return request(`http://172.16.109.99:5000/product_discoveryfilter`, {
  return request(`http://172.16.109.91:5000/live_studio_style_infofilter`, {
...
export function addOne(data) {
  //   console.log("我被调用了？----");
  return request(`http://172.16.109.91:5000/live_studio_style_infoadd`, {
